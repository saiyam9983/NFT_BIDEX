    ...
    <div>
      <section className="collection-sec py-[3rem] ">
        <div className=" max-w-[400px] w-full mx-auto text-center  pb-5">
          <h2 className="capitalize text-2xl font-black text-center pb-2 text-black ">
            Featured Artworks
          </h2>
        ...
        <div className="max-w-[1500px] mx-auto w-full">
          ...
          <p className="font-black text-sm text-black">0.00012 ETH</p>
                      ...
                      <button className="bg-cyan text-black  w-full bg-no-repeat bg-cover rounded-xl py-3 px-2 hover:bg-[#7F00FF] hover:bg-no-repeat hover:bg-cover hover:text-white ">
          Place a Bid
        </button>
                    </div>
                  </div>
