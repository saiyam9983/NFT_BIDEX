  ...
  return (
    <>
      <div className="flex justify-center items-center gap-[20px] md:px-[20px] px-0  py-5 ">
        ...
        <div className="flex-1 text-[#7F00FF]">
          <SearchComponent className="text-[#7F00FF]" placeholder={" by NFTs"} />
        </div>
      </div>
                ...
                <div className="sticky h-auto  md:top-[120px] top-auto bg-white md:max-h-[700px]">
                        ...
                        <Space className=" border-b-2 px-3 py-3">
                          <div className="flex gap-5 justify-between   py-3">
                            <img
                              ...
                              alt=""
                            />
                            {/*<p className="p-0 m-0  font-thin text-[#7F00FF]">
                              Explore
                              <br />
                              Select Blockchain
                            </p>*/}
                  ...
                  <div className="border-b-2 pb-4">
                    ...
                    >
                      <a onClick={(e) => e.preventDefault()}>
                        <Space className=" px-3 py-3">
                          <h4 className="capitalize font-bold text-lg p-0 m-0 text-sm text-[#7F00FF]">
                            status
                          </h4>
                    ...
                    <div className="flex gap-5  pt-5 pb-3">
                      ...
                      <button className="bg-cyan rounded-lg px-4 py-3 text-black font-bold capitalize text-[#7F00FF]">
                        buy now
                      </button>
                    </div>
                    <button className="bg-cyan rounded-lg px-4 py-3 text-black font-bold capitalize text-[#7F00FF]">
                  ...
                  <div className="border-b-2 pb-4">
                    ...
                    <button className="bg-[#7F00FF] rounded-lg px-4 py-3  font-bold capitalize w-full ">
                      Apply
                    </button>
                  </div>
                </div>
                <div className="flex-1">
                  <div className=" bg-no-repeat bg-cover pt-3 px-3 max-h-[700px] overflow-y-scroll">
  ...
  return (
    <>
      <Menu as="div" className="relative inline-block text-left -lg my-5">
        <div>
          <Menu.Button className="inline-flex w-full justify-center border rounded-md bg-white px-4 py-2 text-sm font-medium" >
